...
export const watches: Watch[] = [
  // Paris
  {
    ...
    year: 2023,
    city: "Paris",
    program: "BLACK EDITION",
    price: prices.BLACK_EDITION,
    category: "PLONGÉE",
  ...
  },
  {
    ...
    price: prices.BLACK_EDITION,
    category: "ICONIQUE",
    image: "https://images.unsplash.com/photo-1639037687665-37a99427966a?w=800&q=80",
  },
  {
    id: "5",
    brand: "IWC",
  ...
  },
  {
    ...
    price: prices.LUXURY,
    category: "ICONIQUE",
    image: "https://images.unsplash.com/photo-1606293459339-aa5d34a7b0e1?w=800&q=80",
  },
  {
    id: "9",
    brand: "OMEGA",
  ...
  // Bordeaux
  {
    ...
    price: prices.BLACK_EDITION,
    category: "HABILLÉE",
    image: "https://images.unsplash.com/photo-1623998021446-45cd9b269c95?w=800&q=80",
  },
  {
    id: "12",
  ...
  // Marseille
  {
    id: "14",
    brand: "HUBLOT",
    model: "Big Bang Integral Titanium",
    ref: "451.NX.1140",
    year: 2023,
    city: "Marseille",
    program: "BLACK EDITION",
...
export const programs: { name: Program; price: number; tagline: string; brands: string }[] = [
  {
    ...
    brands: "Tissot, TAG Heuer, Breitling, Omega",
  },
  {
    name: "LUXURY",
    price: prices.LUXURY,
    tagline: "Le plus populaire",
    brands: "Rolex, IWC, Jaeger-LeCoultre, Omega",
  },
  {
    name: "BLACK EDITION",
    price: prices.BLACK_EDITION,
    tagline: "Accès illimité",
    brands: "Rolex Daytona, Audemars Piguet, Patek Philippe",
  },
];
