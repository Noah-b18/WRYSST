    ...
    <div className="min-h-screen bg-white pb-64 sm:pb-44">
      ...
      <div className="site-container grid grid-cols-1 gap-8 py-6 sm:py-10 lg:grid-cols-[minmax(0,55%)_minmax(0,45%)] lg:gap-12">
        ...
        <div className="min-w-0">
          ...
          <span
            className={`inline-block mt-3 text-[10px] font-bold tracking-widest px-2.5 py-1 rounded ${watch.program === "BLACK EDITION" ? "bg-black-edition text-black-edition-foreground" : "bg-primary text-primary-foreground"}`}
          >
            {watch.program}
          </span>
          ...
          >
            ...
            <p className="text-sm font-medium">
              {inZone
                ...
                : `DISPONIBLE À ${watch.city.toUpperCase()} — Livraison 48H`}
            </p>
          </div>
          ...
          <div className="mt-10">
            <h2 className="font-display font-bold text-lg tracking-wider mb-4">
              CONFIGUREZ VOTRE ACCÈS
            </h2>
            <div className="bg-accent border-l-4 border-primary p-4 rounded text-sm">
              Changez de montre quand vous voulez — sans délai minimum, sans frais de changement.
            ...
            <p className="text-xs font-bold tracking-widest mt-6 mb-3">
            ...
            <p className="text-sm mt-1">
              Acompte : <span className="font-bold">{deposit}€</span>
            </p> */}
          </div>
        </div>
      </div>
